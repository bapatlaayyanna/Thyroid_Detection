...
class Data_Getter_Pred:
    """
    This class used for obtaining the data from the source
    """
    ...
    def get_data(self):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,'Exception occured in get_data method of the Data_Getter class:::'+str(e))
