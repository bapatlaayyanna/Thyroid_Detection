...
class dBOperation:
    """
          This class used for handling all the SQL operations.
    ...
    def insertIntoTableGoodData(self,Database):
        """
        Description: This method inserts the Good data files from the Good_Raw folder into the table
        On Failure: Raise Exception
        :param Database:
        :return: None
        """
        ...
        for file in onlyfiles:
            try:
                ...
                conn.rollback()
                self.logger.log(log_file,"Error while inserting data into table: %s " %str(e))
    ...
    def selectingDatafromtableintocsv(self,Database):
        """
        Description: This method exports the data as a CSV file.
        On Failure: Raise Exception
        :param Database:
        :return: None
        """
