...
class File_Operation:
    """
    This class used to save the model after training and load the saved model for prediction.
    """
    ...
    def load_model(self,filename):
        """
        Description: load the model file
        Error on Failure: Raise Exception
        :param filename:
        :return: The Model file loaded in memory
        """
